...
public interface DictionaryResMapper {
    ...
    List<DictionaryVo> getDictionaryList(@Param("type") Integer type, @Param("parentId") Integer parentId, @Param("skip") int skip, @Param("limit") int limit);
    ...
    int getDictionaryVoCount(@Param("type") Integer type, @Param("parentId") Integer parentId);
}
